    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='users.AccountType')),
        ...
        migrations.CreateModel(
            name='AccountTypeThumbnailOption',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, unique=True)),
                ('height', models.PositiveIntegerField()),
                ('width', models.PositiveIntegerField()),
                ('account_type', models.ManyToManyField(related_name='thumbnail_options', to='users.AccountType')),
            ],
            options={
